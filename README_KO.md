...
공식 Nintendo Switch Pro 및 Switch 2 Pro 컨트롤러를 FFXIV에서 인식하고 사용할 수 있게 해 주는 Dalamud 플러그인입니다.
...
- Switch Pro는 USB 및 Bluetooth 연결을 지원합니다.
- Switch 2 Pro는 USB 연결을 지원합니다.
- Switch 2 Pro의 C, GL, GR 버튼을 FFXIV 게임패드 버튼에 매핑할 수 있습니다.
- A/B 및 X/Y 교체 지원.
...
- 공식 Nintendo Switch Pro 및 Switch 2 Pro 컨트롤러만 지원합니다.
- Switch 2 Pro의 Bluetooth 연결은 현재 지원하지 않습니다.
